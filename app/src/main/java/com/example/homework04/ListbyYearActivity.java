...
public class ListbyYearActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listby_year);

        tv_titleValue = findViewById(R.id.tv_title_value_year);
        tv_descValue = findViewById(R.id.tv_desc_value_year);
        tv_genreValue = findViewById(R.id.tv_genre_value_year);
        tv_ratingValue = findViewById(R.id.tv_rating_value_year);
        tv_imbdValue = findViewById(R.id.tv_imdb_value_year);
        tv_yearValue = findViewById(R.id.tv_year_value_year);
        bt_finish = findViewById(R.id.bt_finish_year);
        im_first = findViewById(R.id.im_first_year);
        im_prev = findViewById(R.id.im_prev_year);
        im_last = findViewById(R.id.im_last_year);
        im_next = findViewById(R.id.im_next_year);

        if(getIntent() != null && getIntent().getExtras() != null){

            movieList = (ArrayList<Movie>) getIntent().getExtras().getSerializable(MainActivity.MAIN_MOVIE_LIST_YEAR_KEY);
            currentIndex = 0;
